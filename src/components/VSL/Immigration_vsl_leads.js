...
const Immigration_vsl_leads = () => {
    ...
    useEffect(() => {
        ...
        script2.src = "https://fast.wistia.com/embed/obmmx3vw9t.js";
        script2.type = "module";
        script2.async = true;
    ...
    return (
      ...
      >
        <span className="highlight">Content To Client</span>
            ...
            <div className="vsl-headline">
                <h2>
                    <span className="highlight-white mainHeading">The Immigration Content System </span>
                    <span className="highlight-white mainHeading"> That Converts Views Into</span><br />
                    <span className="highlight-boxed mainHeading"> Paying Customer </span>
      ...
      <style>{`
        wistia-player[media-id='obmmx3vw9t']:not(:defined) { 
          background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/obmmx3vw9t/swatch'); 
          display: block; 
          filter: blur(5px); 
          padding-top:56.25%; 
        }
      ...
      <wistia-player media-id="obmmx3vw9t" aspect="1.7777777777777777"></wistia-player>
...
export default Immigration_vsl_leads;

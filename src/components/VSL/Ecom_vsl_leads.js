...
const Ecommerce_vsl_leads = () => {
    ...
    useEffect(() => {
        ...
        script2.src = "https://fast.wistia.com/embed/btbtxa3kho.js";
        script2.type = "module";
        script2.async = true;
    ...
    return (
      ...
      >
        <span className="highlight">Content To Client</span>
            ...
            <div className="vsl-headline">
                <h2>
                    <span className="highlight-white mainHeading">The Ecommerce Content System </span>
      ...
      <style>{`
        wistia-player[media-id='btbtxa3kho']:not(:defined) { 
          background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/btbtxa3kho/swatch'); 
          display: block; 
          filter: blur(5px); 
          padding-top:56.25%; 
        }
      ...
      <wistia-player media-id="btbtxa3kho" aspect="1.7777777777777777"></wistia-player>
...
export default Ecommerce_vsl_leads;

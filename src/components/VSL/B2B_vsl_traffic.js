...
const B2B_vsl_traffic = () => {
    ...
    useEffect(() => {
        ...
        script2.src = "https://fast.wistia.com/embed/cghvkeuzbq.js";
        script2.type = "module";
        script2.async = true;
    ...
    return (
        ...
        <span className="highlight" style={{fontSize:"5rem"}}>From Zero Views to Insane Traffic</span>
            ...
            <div className="vsl-headline">
                <h2>
                    ...
                    <span className="highlight-white mainHeading">Why SaaS Founders Struggle on YouTube</span><br/>
      ...
      <style>{`
        wistia-player[media-id='cghvkeuzbq']:not(:defined) { 
          background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/cghvkeuzbq/swatch'); 
          display: block; 
          filter: blur(5px); 
          padding-top:56.25%; 
        }
      ...
      <wistia-player media-id="cghvkeuzbq" aspect="1.7777777777777777"></wistia-player>
...
export default B2B_vsl_traffic;
